...
logging.getLogger('sorl').setLevel(logging.ERROR)
...
BASE_URL = 'http://dev.knotis.com'  # NO TRAILING SLASH!!!
...
NOMINATIM_API = 'nominatim.knotis.com/search/'
NOMINATIM_REVERSE_API = 'nominatim.knotis.com/reverse/'
ANONYMOUS_USER_ID = -1
