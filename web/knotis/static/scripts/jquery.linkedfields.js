  ...
  */
  $.fn.link_field = function(group, update, get_val){
    ...
    $(this).each(function(){  
      ...
      this.addEventListener('linkfieldsprogrammaticchange', (function(self, group){
        return function(e){
          if(e.group == self.group){
            self.external_update(e.val);
          }
        };
      })(this, group));
      
      $.fn.link_field.force_sync = (function(self, group){
        return function(val){
          $('[data-link-group=' + group + ']').trigger('linkfieldsprogrammaticchange', {group: group, val: val});
        };
      })(this, group);
          
      $.fn.link_field.external_update = function(group, val){
        var a = $('[data-link-group=' + group + ']');
        a.each(function(){
          if($(this).is('input')){
            $(this).val(val);
          }else{
