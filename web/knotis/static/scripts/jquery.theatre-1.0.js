 ...
 * @revision   $Revision: 4711 $
 * @changed    $Date: 2011-05-02 16:14:53 +0200 (Mon, 02 May 2011) $
 * @access     public
 */
(function($) {
	var effects={};
	...
	methods.init=function(options) {
		...
		// Actors
		actors.each(function(){var $this=$(this); if (!$this.data('theatre')) $this.data('theatre', {width: $this.width(), height: $this.height()});});		
