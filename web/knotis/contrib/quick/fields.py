...
class QuickDateTimeField(QuickField, QuickFieldDefaultMixin, models.DateTimeField):
    pass
...
class QuickIntegerField(QuickField, QuickFieldDefaultMixin, models.IntegerField):
    pass
